...
Earth Staking Governance (ESG) is a 100% fair launched token, available to early Earth Stakers. To participate, click the 'Delegate to ESG' button on the staking page to earn ETH staking rewards + ESG governance tokens.
...
>
  Earn ETH staking rewards + ESG tokens for a limited time
</Card>
