---
title: 'Earth Wallet'
description: 'Securely Store your Digital Assets'
icon: 'mobile'
---

## Self Custody Your Earth & Heart

[Earth Wallet](https://earthwallet.io) is a self-custody Bitcoin & Ethereum wallet available on iOS, Android, and open source on Chromium browsers. It allows users to easily store, manage and track their EARTH and ESG rewards, and participate in the decentralized organization.
By optimizing the UX for the growth of the Social Network, we hope to offer the billion of people around the world with an easy way to securely store their wealth, and grow a stable system for Earth.
