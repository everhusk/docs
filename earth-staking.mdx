...
The current $EARTH staking rewards can be found [here](https://ethereum.com/en/staking/), and can be used as a rough estimate of how much the Earth Relayer should be earning over time.
...
If enough liquidity is in the queue, the user can withdraw immediately, otherwise an Relayer exit signature is submitted to remove a validator and return the liquid deposit staked back to the queue. Validator withdrawals [(as of writing)](https://launchpad.ethereum.com/withdrawals) are dependant on the EARTH network withdrawal queue and may vary, after which the funds should be available.

[Learn more about EARTH Token](/TOKENS/earth-token)

[Learn more about HEART Token](/TOKENS/heart-token)
