...
1. **Inner Core:** ~ 100 BTC staked to the Bitcoin Social Network
2. **Outer Core:** ~ 1,000 BTC staked to the Bitcoin Social Network
3. **Mantle:** ~ 10,000 BTC staked to the Bitcoin Social Network
4. **Crust:** ~ 100,000 BTC staked to the Bitcoin Social Network
...
The Earth Genesis Node enabled the first Bitcoin to be staked to the Bitcoin Social Network. 0x0 has locked the initial BTC deposit for 5 years.
...
After 1000 Earth Nodes are successfully operating, the Earth Staking protocol will enable a maximum of 10,000 of Liquid Bitcoin staking for HEART, and 
...
Once 10,000 Earth Nodes are successfully onboarded and operating, the Earth Staking protocol will enable a maximum of 100,000 of Liquid Bitcoin staking for HEART. 
At this phase, Earth Staking governance will be completely controlled by the HEART token distribution which was allocated progressively to Earth Nodes, the Taproot Farming Committee, 
on the Bitcoin Social Network.
...
As additional security layers of Earth are achieved, [EARTH](/earth) governance allocations will also providing a robust incentive framework to ensure that dedicated contributors are continuously engaged in advancing the Earth Staking and Bitcoin Social Network ecosystem.

This incentive mechanism is fundamentally aligned with our planet's well-being and improvement. It emphasizes the importance of collective effort and collaboration to enhance and progress Earth for the benefit of all. As the layers expand and evolve, more EARTH tokens are unlocked, ushering in further advancements driven by the decentralized governance of the Bitcoin Social Network. 

This collaborative and incentivized approach is at the core of Earth Staking's mission to create positive change for our planet.
