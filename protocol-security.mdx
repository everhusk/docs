...
Initial Taproot Farmer RFP was made on the Bitcoin Talk Forum, and with ERC-7777, with the initial farmer invitation codes sent to the following security companies, and Bitcoin & Ethereum core contributors:

- Earth Ecosystems (Approved)
- Lodestar / Chainsafe Systems (Auditing)
- Halborn Security (Auditing)
- Ethereum Foundation (Contacted)
- BloxRoute (Reviewing)
- Teku / Consensys (TBD)
- Lighthouse / Sigma Prime (TBD)
- Prysm / Prysmatic Labs (TBD)
- Nimbus (TBD)
