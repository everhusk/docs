...
Earth Staking aims to be a fully decentralized ecosystem, and as such, is organized in a way that anyone can contribute to the open source code by completing any of the bounties below.
...
<ResponseField name="Social Network" type="BTC" required>
  ...
  <Expandable title="Bounty">
    ...
    ## Moving from Bitcoin to the Social Network
      ...
      4) Earth Nodes will submit signatures , Earth Nodes will submit their signature to the Earth Staking Controller, to trigger a transfer of funds to a new Merkle Distributor.
      This transfer will enable a new set of withdrawals to occur, based off of any withdrawal or deposits made to the Earth Staking Controller since the last block.
