...
description: 'Uniting the Social Networks of Earth'
---
...
Earth Nodes are the decentralized network of validators who can run nodes on the protocol and decentralize the Earth Staking protocol, to participate you will need to 2 ETH and 5 ETH worth of HEART, which is pooled with 30 ETH from the Earth Staking protocol to validate and earn Ethereum block rewards.

There are two main ways to obtain HEART:

1) Deposit your EARTH & BTC to the seed liquidity pool. Early liquidity providers will earn HEART tokens proportional to the amount of time they provide liquidity, and the amount of liquidity they provide.

2) Purchase HEART on secondary markets.

Once you obtain HEART, visit the [launchpad](https://launch.earthstaking.com), and follow the steps to deploy an Earth Staking Governance Node.
...
2. Earn HEART benefits as the ecosystem matures and scales its social and governance systems.
